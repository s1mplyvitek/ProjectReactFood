    ...
    return (
        <>
            <div className="w-2/3 mx-auto flex flex-col grow items-center text-xl mb-10">
                <h2 className="py-5 text-orange-600 font-bold text-xl sm:text-3xl mt-10 min-[530px]:mt-0">Рестораны</h2>
                <div className="mb-5 sm:mb-10">
                    <Maps />
                </div>
            </div>

            <div className="sm:w-2/3 px-3 sm:px-0 mx-auto flex flex-col grow items-center text-xl mb-10">
