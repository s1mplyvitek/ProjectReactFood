...
const Footer = () => {
    return (
        <footer className="h-full  bg-slate-100">
            <div className="flex flex-col items-center min-[1230px]:grid grid-cols-5 gap-5 py-5 w-3/4 mx-auto">
                ...
                <div className="col-span-3">
                    <ul className="flex flex-col min-[690px]:grid grid-cols-4 mb-6 text-gray-500 text-sm">
                        <li><span className="font-bold text-lg text-gray-700 ">Компания</span>
                            <ul className="">
                                <li>О нас</li><li>Рестораны</li>
                            </ul>
                        </li>
                        <li> <span className="font-bold text-lg text-gray-700">Партнерам</span>
                            <ul>
                                <li>Франшиза</li><li>Аренда</li><li>Снабжение</li>
                            </ul>
                        </li>
                        <li> <span className="font-bold text-lg text-gray-700">Документы</span>
                            <ul>
                                <li>Публичная оферта</li><li>Соглашение</li><li>Подробное меню</li>
                            </ul>
                        </li>
                        <li> <span className="font-bold text-lg text-gray-700">Контакты</span><br />
                ...
                <div className="grid justify-items-center">
                    <p> <span className="font-bold text-lg text-gray-700 ">Наши соцсети</span></p>
